...
class MIAmSTag (MIAmSWf):
    ...
    def define_parameters(self, parameters_section=None):
        ...
        self.add_parameter("instability_ratio", 'Only if consensus-method is equal to "ratio". The threshold to determine if the sample is stable or unstable. If the ratio of unstable/determined loci is upper or equal than this value the sample will be unstable otherwise it will be stable.', default=0.4, type=float, group="Sample classification parameters")
